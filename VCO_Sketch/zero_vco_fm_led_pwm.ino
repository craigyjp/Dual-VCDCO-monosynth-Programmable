...
void setup() {
  pinMode(OCT_SEL_A, INPUT);    //oct select
  pinMode(OCT_SEL_B, INPUT);    //oct select
  pinMode(MODE_1, INPUT);       //mode select
  pinMode(MODE_2, INPUT);       //mode select
  pinMode(WAVE_1, INPUT);       //mode select
  pinMode(WAVE_2, INPUT);       //mode select
  pinMode(WAVE_2, INPUT);       //mode select
  timer = micros();
...
void loop() {
  ...
  //-------------------octave select-------------------------------
  if (digitalRead(OCT_SEL_A) == 1 && digitalRead(OCT_SEL_B) == 1) {
    oct_sw = 1;
  } else if (digitalRead(OCT_SEL_A) == 0 && digitalRead(OCT_SEL_B) == 1) {
    oct_sw = 3;
  } else if (digitalRead(OCT_SEL_A) == 1 && digitalRead(OCT_SEL_B) == 0) {
    oct_sw = 0;
  }

  //  -------------------mode select-------------------------------
  if (digitalRead(MODE_1) == 1 && digitalRead(MODE_2) == 1) {
    mode = 1;  //fm
  } else if (digitalRead(MODE_1) == 0 && digitalRead(MODE_2) == 1) {
    mode = 0;  //AM
  } else if (digitalRead(MODE_1) == 1 && digitalRead(MODE_2) == 0) {
    mode = 2;  //wavefolder
  }
  ...
  //  -------------------push sw-------------------------------
  if (digitalRead(WAVE_1) == 0 && digitalRead(WAVE_2) == 0 && digitalRead(WAVE_3) == 0) {
    waveform = 0;
  }
  if (digitalRead(WAVE_1) == 1 && digitalRead(WAVE_2) == 0 && digitalRead(WAVE_3) == 0) {
    waveform = 1;
  }
  if (digitalRead(WAVE_1) == 0 && digitalRead(WAVE_2) == 1 && digitalRead(WAVE_3) == 0) {
    waveform = 2;
  }
  if (digitalRead(WAVE_1) == 1 && digitalRead(WAVE_2) == 1 && digitalRead(WAVE_3) == 0) {
    waveform = 3;
  }
  if (digitalRead(WAVE_1) == 0 && digitalRead(WAVE_2) == 0 && digitalRead(WAVE_3) == 1) {
    waveform = 4;
  }
  if (digitalRead(WAVE_1) == 1 && digitalRead(WAVE_2) == 0 && digitalRead(WAVE_3) == 1) {
    waveform = 5;
  }
  if (digitalRead(WAVE_1) == 0 && digitalRead(WAVE_2) == 1 && digitalRead(WAVE_3) == 1) {
    waveform = 6;
  }
  if (digitalRead(WAVE_1) == 1 && digitalRead(WAVE_2) == 1 && digitalRead(WAVE_3) == 1) {
    waveform = 7;
  }
  // push_sw = digitalRead(PUSH_BUTTON);
